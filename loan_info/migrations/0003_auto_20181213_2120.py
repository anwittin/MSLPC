# Generated by Django 2.1.4 on 2018-12-14 05:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('loan_info', '0002_auto_20181213_2118'),
    ]
    ...
    operations = [
        ...
        migrations.RemoveField(
            model_name='loandetail',
            name='loan_payment_currency',
        ),
        migrations.AlterField(
            model_name='loandetail',
            name='loan_current_balance',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=10, verbose_name='Current Loan Balance'),
        ),
        migrations.AlterField(
            model_name='loandetail',
            name='loan_current_balance_currency',
